                ...
                <ul class="nav responsive-tab nav-material nav-material-white" id="v-pills-tab">
                    <li>
                        <a class="nav-link active" id="v-pills-1-tab" data-toggle="pill" href="#gkurikulum">
                            <i class="icon icon-home2"></i>Data Semester</a>
                    </li>
                    <li>
                        <a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#tbh-gkurikulum">
                            <i class="icon icon-plus-circle mb-3"></i>Tambah Semester</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card my-3 no-b">
                            <div class="card-body">
                                <div class="card-title">Data Semester</div>
                    ...
                    <div class="col-md-4">
                        <div class="card text-white bg-info my-3 no-b">
                            <div class="card-header no-b">Semester Aktif</div>
                            <div class="card-body text-info">
                                <h2 class="card-title">2018/2019 Smt Genap</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group m-0">
                                                <label for="name" class="col-form-label s-12">NAMA SEMESTER</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-0">
                                                <label for="name" class="col-form-label s-12">TAPEL</label>
